# Food Deserts in the United States: Mapping Exclusion and Systemic Inequality
...
### Part 1: Understanding Food Deserts
The first section establishes a foundational understanding of food deserts using USDA definitions and criteria. Through detailed visualizations:
- **Precise descriptions** of what constitutes a food desert
- **State-by-state comparisons** showing how these characteristics vary across regions
- **Zoomed-in geographical views** that highlight the specific characteristics distinguishing food desert areas from surrounding communities

### Part 2: Population & Demographic Layers
The second section examines the populations most affected by food deserts through multiple data layers:
- **Poverty levels** and their spatial relationship to food deserts
...
**Maria Ferro**  
Data Journalism Final Project | 2026
